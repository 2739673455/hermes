...
## 9. 技能系统（Skills）
技能（Skills）是 Hermes 最独特的功能之一。当你解决了一个复杂问题或者发现了一个好用的工作流，可以把它保存为技能，让 Hermes 在下一次遇到类似任务时自动加载。
...
### 如何创建一个技能
技能文件是一个带 YAML 元数据头部的 Markdown 文件（`SKILL.md`），结构如下：

```markdown
---
name: my-cool-workflow
description: "一个酷炫的工作流"
version: 1.0.0
author: Your Name
---
